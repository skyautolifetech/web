$(window).on("load", function() {
  "use strict";
  var preloader = $("#loading"), loader = preloader.find("#loading-center");
  loader.fadeOut();
  ...
  $(".popup-floorpan").magnificPopup({
    ...
    iframe: {
      patterns: {
        youtube: {
          index: "youtube.com",
          src: "https://www.youtube.com/embed/geXBYnTDrrs?vq=hd1080&rel=0&modestbranding=1&autoplay=1&mute=1&controls=1&enablejsapi=1"
        }
      }
    },
    callbacks: {
...
!function(e, t) {
  ...
  ce.fn = ce.prototype = { jquery: t, constructor: ce, length: 0, toArray: function() {
    ...
    } else while (t2 = e2[r2++]) n2 += ce.text(t2);
    return n2;
  ...
  function V(e2, t2, n2) {
    var r2, i2;
    if (void 0 === n2 && 1 === e2.nodeType) if (r2 = "data-" + t2.replace(z, "-$&").toLowerCase(), "string" == typeof (n2 = e2.getAttribute(r2))) {
      try {
  ...
  ce.extend({ hasData: function(e2) {
    ...
    return "object" == typeof n2 ? this.each(function() {
      ...
      var t3;
      if (o2 && void 0 === e3) return void 0 !== (t3 = X.get(o2, n2)) ? t3 : void 0 !== (t3 = V(o2, n2)) ? t3 : void 0;
      this.each(function() {
        X.set(this, n2, e3);
      });
  ...
  function $e(n2, r2, i2, o2) {
    ...
    if (f2 && (t2 = (e2 = Ae(r2, n2[0].ownerDocument, false, n2, o2)).firstChild, 1 === e2.childNodes.length && (e2 = t2), t2 || o2)) {
      ...
      if (s2) for (l2 = a2[a2.length - 1].ownerDocument, ce.map(a2, We), c2 = 0; c2 < s2; c2++) u2 = a2[c2], Ce.test(u2.type || "") && !_.access(u2, "globalEval") && ce.contains(l2, u2) && (u2.src && "module" !== (u2.type || "").toLowerCase() ? ce._evalUrl && !u2.noModule && ce._evalUrl(u2.src, { nonce: u2.nonce || u2.getAttribute("nonce") }, l2) : m(u2.textContent.replace(Re, ""), u2, l2));
    }
    return n2;
  }
  ...
  ce.extend({ cssHooks: { opacity: { get: function(e2, t2) {
    ...
    ce.cssHooks[u2] = { get: function(e3, t2, n2) {
      if (t2) return !et.test(ce.css(e3, "display")) || e3.getClientRects().length && e3.getBoundingClientRect().width ? ot(e3, u2, n2) : ze(e3, tt, function() {
        return ot(e3, u2, n2);
      });
    ...
    if (t2) return (parseFloat(Ge(e2, "marginLeft")) || e2.getBoundingClientRect().left - ze(e2, { marginLeft: 0 }, function() {
    ...
    return R(this, function(e3, t3, n2) {
      var r2, i2, o2 = {}, a2 = 0;
      if (Array.isArray(t3)) {
        for (r2 = Ue(e3), i2 = t3.length; a2 < i2; a2++) o2[t3[a2]] = ce.css(e3, t3[a2], false, r2);
        return o2;
      }
...
})(this, function(module2, exports2) {
  "use strict";
